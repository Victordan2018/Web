...
<body bgcolor="#999999">
<center>
                            <h1>BUSQUEDA DE PRODUCTOS DE MATERIALES Y HERRAMIENTAS</h1>
                            <form action="materialesyherramientas.php" method="post">
               <input name="mat" type="text">
...
?>
                           ...
                           <h1>TODOS LOS PRODUCTOS DE MATERIALES Y HERRAMIENTAS</h1></center>
							  <?php
							  $resultado=mysqli_query($conexion,"select * from producto where categoria like 'materiales y herramientas'")or die(mysqli_error());
